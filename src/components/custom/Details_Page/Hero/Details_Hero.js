...
export default function HeroSection({
  ...
  onError={(e) => {
    ...
    e.currentTarget.src = "/fallback.jpg"; // your fallback image path
  }}
          ...
          <div className="lg:w-[25%] w-full py-6 px-6 flex flex-col justify-between bg-white shadow-lg rounded-2xl">
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-700">
                <li className="flex items-center gap-3">
                  <MapPin size={18} className="text-gray-600" /> {address}
                </li>
                <li className="flex items-center gap-3">
                  <Ruler size={18} className="text-gray-600" /> {size}
                </li>
                <li className="flex items-center gap-3">
                  <LocateFixed size={18} className="text-gray-600" /> {location}
                </li>
                <li className="flex items-center gap-3">
                  <Navigation size={18} className="text-gray-600" /> {distance}
                </li>
                <li className="flex items-center gap-3">
                  <IndianRupee size={18} className="text-gray-600" /> {priceRange}
                </li>
              </ul>
            </div>
            ...
            <div className="pt-5 border-t mt-5">
              ...
              <ul className="space-y-3 text-sm text-gray-700">
                <li className="flex items-center gap-3">
                  <Phone size={18} className="text-gray-600" /> {phone}
                </li>
                <li className="flex items-center gap-3">
                  <Mail size={18} className="text-gray-600" /> {email}
                </li>
              </ul>
            </div>
          </div>
