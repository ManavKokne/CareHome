    ...
    return (
        <section className="relative py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="absolute left-0 right-0 top-74 h-[60%] bg-purple-50 -z-10 w-screen mx-0" />
                ...
                <p className="mt-6 text-[#3A0CA3] font-semibold cursor-pointer text-center lg:text-left">
                    View all Care Homes ➜
                </p>
            </div>
        </section>
